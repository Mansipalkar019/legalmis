...
<body class="text-center">
	...
	<main class="form-signin">
		...
		<div class="form-floating">
			<input type="text" name="username" class="<?= $eError ?>" placeholder="Username" value="sufian">
		...
		<div class="form-floating">
			<input type="password" name="password" class="<?= $pError ?>" placeholder="Password" value="123456">
