...
<div class="container invoice-box img-responsive" >
   <table cellpadding="0" cellspacing="0" style="background-image:url('<?php echo base_url() ?>assets_admin/images/letterhead.png'); 
