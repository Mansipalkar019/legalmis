                  ...
                  <div class="panel">
                     <div class="panel-heading nopaddingbottom" style="width: 100%">
                        ...
                        <div class="card-body" style="padding: 20px;">
                           ...
                           <?php
                              $html = "";
                              // echo '<pre>'; print_r($sale_service_brand);
                              foreach($sale_service_brand as $sale_service_brand_key => $sale_service_brand_row){     
                                 $class_name_key = 0;   ?>      
                                 <div class="row">
                                    <div class="col-md-6" id="show_brand_content_<?=$sale_service_brand_key?>">
                                       <div class="form-group"><label>Enter Brand Name
                                    ...
                                    <?php if(!empty($sale_service_brand_row['class_name'])){ ?>
                                       <div class="col-md-6" id="show_company_content_<?=$sale_service_brand_key?>">
                                          <div class="form-group">
