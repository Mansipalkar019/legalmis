            ...
            <div class="tab-content tabs">
               <div role="tabpanel" class="tab-pane fade in active" id="invoicetype">
                  ...
                  <form id="basicForm" method="post"
                     ...
                     onsubmit="return validate_add_invoice_type(this);">
                  ...
                  <hr>
                  <table id="invoiceype_datatable" class="table table-striped table-bordered" style="width:100%">
                     <thead>
                        <tr>
                           <th>ID</th>
                           <th>Name</th>
                  ...
                  <div id="invoicetypeModal" class="modal fade" role="dialog">
                     <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                           ...
                           <form id="basicForm" method="post"
                              enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate"
                              onsubmit="return validate_update_invoice_type(this);">
...
<script src="<?php echo base_url();?>assets_admin/view_js/invoivetype.js"></script>
...
var simpletable = $('#invoiceype_datatable').DataTable({
      // "dom": 'lBfrtip',
      dom: 'lBfrtip',
             buttons: [
 'csvHtml5',
