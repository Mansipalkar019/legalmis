...
class Document_list_model extends CI_Model {
    ...
    {    
        $column_order = array('name','service_name');
        $column_search = array('name','service_name');

            $this->db->select('document_list.*,services.name as service_name');
	        ...
	        $this->db->order_by('document_list.id','DESC'); 
